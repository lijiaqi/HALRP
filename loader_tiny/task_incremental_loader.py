...
from .idataset import DummyArrayDataset
import os
...
class IncrementalLoader:
    ...
    def __init__(
        ...
        self._setup_data(class_order_type=opt.class_order,
                         seed=seed,
                         increment=increment,
    ...
    def new_task(self):
        ...
        x_train, y_train = self.train_dataset[self._current_task][1][p], self.train_dataset[
            self._current_task][2][p]
        x_test, y_test = self.test_dataset[self._current_task][1], self.test_dataset[
    ...
    def _setup_test_tasks(self):
        ...
        for i in range(len(self.test_dataset)):
            self.test_tasks.append(
                self._get_loader(self.test_dataset[i][1], self.test_dataset[i][2], mode="test"))
    ...
    def get_dataset_info(self):
        ...
        return n_inputs, n_outputs.item() + 1, self.n_tasks, n_inputs
    ...
    def _get_loader(self, x, y, shuffle=True, mode="train"):
        ...
        return DataLoader(DummyArrayDataset(x, y),
